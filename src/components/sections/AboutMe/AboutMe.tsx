    ...
    <section className='relative mx-auto container px-2 pt-44 lg:h-screen overflow-hidden lg:pt-0 lg:w-[50vw] flex flex-col justify-center gap-4'>
      <div className='flex flex-col items-center lg:flex-row-reverse lg:justify-center lg:items-center md:gap-x-4'>
        ...
        <header className='lg:w-4/5 text-center'>
          <Text type="HEADING_1" message="hola," styles={{ className: "text-3xl font-bold lg:text-5xl lg:leading-[4rem] capitalize text-dark-700 dark:text-dark-200" }}>
          ...
          <Text type="HEADING_2" message={aboutMe} styles={{ className: "text-xl text-pretty" }} />
        </header>
      </div>
      <ul className="mt-10 flex flex-wrap gap-4 justify-start ">
        <li>
          <a href="https://www.linkedin.com/in/cristian-arranz-arevalo/" className="rounded-full text-dark-800 dark:text-dark-200 border border-dark-300 dark:border-dark-700 flex justify-center items-center gap-x-2 py-1 px-2 md:py-2 text-xs md:text-base md:px-4 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-950 hover:scale-105 transition-transform" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://github.com/CrisArranz" className="rounded-full text-dark-800 dark:text-dark-200 border border-dark-300 dark:border-dark-700 flex justify-center items-center gap-x-2 py-1 px-2 md:py-2 text-xs md:text-base md:px-4 bg-gradient-to-r from-slate-50 to-slate-100  dark:from-slate-800 dark:to-slate-950 hover:scale-105 transition-transform" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="mailto:c.arranz.arevalo@gmail.com" className="rounded-full text-dark-800 dark:text-dark-200 border border-dark-300 dark:border-dark-700 flex justify-center items-center gap-x-2 py-1 px-2 md:py-2 text-xs md:text-base md:px-4 bg-gradient-to-r from-slate-50 to-slate-100  dark:from-slate-800 dark:to-slate-950 hover:scale-105 transition-transform" target="_blank" rel="noopener noreferrer">
            <svg className="size-4 md:size-6" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M11 19h-6a2 2 0 0 1 -2 -2v-10a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v6"></path><path d="M3 7l9 6l9 -6"></path><path d="M15 19l2 2l4 -4"></path></svg> Email Me!
          </a>
        </li>
      </ul>
      <div className="absolute hidden lg:flex bottom-4 w-full justify-center">
        <a href="#experience" className="md:flex gap-2 animate-bounce text-emerald-600 dark:text-primary-400 font-bold">
          Experiencia <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m0 0l6.75-6.75M12 19.5l-6.75-6.75"></path></svg>
        </a>
      </div>
    </section>
  );

...
export const Experience: React.FC<ExperienceProps> = ({ id }) => {
  return (
    <section id={id} className="relative mx-auto container px-6 pt-24 lg:h-screen overflow-hidden lg:pt-0 lg:w-[750px] lg:flex lg:flex-col lg:justify-center">
      <Typography type="HEADING_2" message="Experiencia" styles={{ className: "text-3xl font-bold text-black dark:text-white" }} />
      <article className="container px-2 mt-10">
        <ul className="relative border-l border-emerald-400 dark:border-emerald-700">
          <li className="mb-8 md:mb-6 ml-6">
            ...
            <Typography message="Software Engineer" type="HEADING_3" styles={{ className: "flex items-center gap-2 mb-1 text-lg font-semibold text-black dark:text-white" }}>
              <Typography type="SPAN" message=" - " styles={{ className: "dark:text-white text-black font-normal" }} />
              <Typography type="SPAN" message="Openbank" styles={{ className: "text-sm text-fuchsia-800 dark:text-fuchsia-300/90" }} />
            </Typography>
          ...
          <li className="mb-8 md:mb-6 ml-6">
            ...
            <Typography message="Teach Assistant" type="HEADING_3" styles={{ className: "flex items-center gap-2 mb-1 text-lg font-semibold text-black dark:text-white" }}>
              <Typography type="SPAN" message=" - " styles={{ className: "dark:text-white text-black font-normal" }} />
              <Typography type="SPAN" message="Ironhack" styles={{ className: "text-sm text-fuchsia-800 dark:text-fuchsia-300/90" }} />
            </Typography>
            <time className="block mb-2 text-sm font-normal leading-none text-black dark:text-white">Noviembre 2022 - Febrero 2024</time>
          ...
          <li className="mb-8 md:mb-6 ml-6">
            ...
            <Typography message="Fullstack Developer" type="HEADING_3" styles={{ className: "flex items-center gap-2 mb-1 text-lg font-semibold text-black dark:text-white" }}>
              <Typography type="SPAN" message=" - " styles={{ className: "dark:text-white text-black font-normal" }} />
              <Typography type="SPAN" message="Alvea" styles={{ className: "text-sm text-fuchsia-800 dark:text-fuchsia-300/90" }} />
            </Typography>
          ...
          <li className="mb-8 md:mb-6 ml-6">
            ...
            <Typography message="Fullstack Developer" type="HEADING_3" styles={{ className: "flex items-center gap-2 mb-1 text-lg font-semibold text-black dark:text-white" }}>
              <Typography type="SPAN" message=" - " styles={{ className: "dark:text-white text-black font-normal" }} />
              <Typography type="SPAN" message="Antartyca" styles={{ className: "text-sm text-fuchsia-800 dark:text-fuchsia-300/90" }} />
            </Typography>
          ...
          <li className="mb-8 md:mb-6 ml-6">
            ...
            <Typography message="Fullstack Developer" type="HEADING_3" styles={{ className: "flex items-center gap-2 mb-1 text-lg font-semibold text-black dark:text-white" }}>
              <Typography type="SPAN" message=" - " styles={{ className: "dark:text-white text-black font-normal" }} />
              <Typography type="SPAN" message="Steelmood" styles={{ className: "text-sm text-fuchsia-800 dark:text-fuchsia-300/90" }} />
            </Typography>

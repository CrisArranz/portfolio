  ...
  return (
    <div className="flex flex-col items-center dark:text-white">
      <div className="relative rounded-full w-60 h-60 overflow-hidden md:h-96 md:w-96">
        <Image src="https://res.cloudinary.com/dp520ozjl/image/upload/v1671669667/personal/IMGCV_CristianArranzArevalo_zcgj2u.jpg" sizes="100vw" fill className="absolute object-cover object-top" alt="Cristian Arranz Arevalo" />
      </div>
